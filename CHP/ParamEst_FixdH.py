...
def error(param):
    sol0 = odeint(ODEfun, y0, Lspan, (Ax,Fa0,rho,Ca0,param[0],param[1],dH,Ta0,param[2],mc,CpCP,CpCM,CpH2,CpCA))
    sol1 = odeint(ODEfun, y1, Lspan, (Ax,Fa0,rho,Ca0,param[0],param[1],dH,Ta0,param[2],mc,CpCP,CpCM,CpH2,CpCA))
    sol2 = odeint(ODEfun, y2, Lspan, (Ax,Fa0,rho,Ca0,param[0],param[1],dH,Ta0,param[2],mc,CpCP,CpCM,CpH2,CpCA))
    sol3 = odeint(ODEfun, y3, Lspan, (Ax,Fa0,rho,Ca0,param[0],param[1],dH,Ta0,param[2],mc,CpCP,CpCM,CpH2,CpCA))
...
num_parents_mating = 20	# Mating pool size
...
ax1.text(-450, 300,
         ...
         '\n'
		 r'dH = 'f'{dH:.0f} (J/mol) : Fixed'
		 '\n'
		 r'UA = 'f'{param[2]:.0f} (J/cm2/hr/K)'
