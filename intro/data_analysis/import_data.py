...
# load the data file
data_file = np.genfromtxt('data_analysis\data_file.txt', delimiter=',')
...
np.savetxt('data_analysis\export_from_python.txt',my_data,delimiter=',')
...
plt.legend(['Sensor 0','Average Sensors 1-4'])
plt.xlabel('Time (min)')
plt.ylabel('Sensor Values')
# save the figure as a PNG file
plt.savefig('data_analysis\my_Python_plot.png')
