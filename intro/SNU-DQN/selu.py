...
def fully_connected(inputs, output_size, activation_fn=None, weights_initializer=layers.variance_scaling_initializer(factor=1.0, mode='FAN_IN'),\
        weights_regularizer=tf.contrib.layers.l2_regularizer(0.01), biases_initializer=tf.constant_initializer(0.0)):
