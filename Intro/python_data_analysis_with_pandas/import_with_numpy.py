...
# load the data file
data_file = np.genfromtxt('python_data_analysis_with_pandas/data_file.txt', delimiter=',')
...
np.savetxt('python_data_analysis_with_pandas/export_from_python.txt',my_data,delimiter=',')
