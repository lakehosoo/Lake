...
# load the data file
data_file = pd.read_csv('python_data_analysis_with_pandas/data_with_headers.csv')
...
result.to_csv('python_data_analysis_with_pandas/result.csv')
result.to_excel('python_data_analysis_with_pandas/result.xlsx')
result.to_html('python_data_analysis_with_pandas/result.htm')
result.to_clipboard()
...
plt.savefig('python_data_analysis_with_pandas/my_Python_plot.png')
